...
if __name__ == '__main__':
    ...
    in_file_name = 'C:/Users/usuario/Documents/Dev/grpc-file-transfer/src/tmp/file.parquet'
    print("FAZENDO UPLOADING DO ARQUIVO PARQUET")
    client.upload(in_file_name)

    #demo for file downloading:
    out_file_name = 'C:/Users/usuario/Documents/Dev/grpc-file-transfer/src/tmp/'
